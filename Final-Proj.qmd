...
### 1. Overall Gendered Refugee Populations by Country of Asylum
```{python}
# | label: fig-map
...
### 2. Situation of Refugees in Europe
...
### 4. Specific Conflict Study: Conflict between Russia and Ukraine (2014 - 2022)
...
### 5. Global and European Refugee Flow
```{python}
import pandas as pd
import numpy as np
...
### 6. Specific Conflict Study: Conflict of Balkans (2002 - 2010)
